 ...
 * @author Yoselin
 */
public class AccountCodeSmells {
    private String type;
       private String accountNumber;
       private int amount;
      
       public AccountCodeSmells(String type,String accountNumber,int amount)
       {
              this.amount=amount;
              this.type=type;
       ...
       public void transfer(AccountCodeSmells from,AccountCodeSmells to,int cerditAmount) throws Exception
       {
              if(from.amount <= 500)
              {
                     throw new Exception("Mininum balance shuold be over 500");
